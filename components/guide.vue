...
<template>
  <section class="flexCenter flex-col">
    <div class="padding-container max-container w-full pb-24">
      <NuxtImg src="/img/camp.svg" alt="camp" width="50" height="50" />
      <p class="uppercase regular-18 -mt-1 mb-3 text-green-50">
        We are here for you
      </p>
      <div class="flex flex-wrap justify-between gap-5 lg:gap-10">
        <h2 class="bold-40 lg:bold-64 xl:max-w-[390px]">Guide You to Easy Path</h2>
        <p class="regular-16 text-gray-30 xl:max-w-[520px]">Only with the hilink application you will no longer get lost and get lost again, because we already support offline maps when there is no internet connection in the field. Invite your friends, relatives and friends to have fun in the wilderness through the valley and reach the top of the mountain</p>
      </div>
    </div>
    ...
    <div class="flexCenter max-container relative w-full">
      ...
      <div class="absolute flex bg-white py-8 pl-5 pr-7 gap-3 rounded-3xl border shadow-md md:left-[5%] lg:top-20">
        <NuxtImg 
          ...
          class="h-full w-auto"
        />
        <div class="flexBetween flex-col">
          <div class='flex w-full flex-col'>
            <div class="flexBetween w-full">
